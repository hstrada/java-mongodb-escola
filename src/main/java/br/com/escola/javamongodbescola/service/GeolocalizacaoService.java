package br.com.escola.javamongodbescola.service;
...
import br.com.escola.javamongodbescola.model.Contato;

@Service
public class GeolocalizacaoService {

	public List<Double> obterLatELongPor(Contato contato) throws ApiException, InterruptedException, IOException {
		GeoApiContext context = new GeoApiContext().setApiKey("AIzaSyAkokZQHkQuzRdAhuAvLWMbSt4XYeLgVqA");
